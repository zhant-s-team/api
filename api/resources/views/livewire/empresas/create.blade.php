            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('empresas.store') }}" enctype="multipart/form-data">
                        ...
                        <!-- Campo Logo -->
                        <div class="mb-4">
                            <label for="logo" class="block text-sm font-medium text-gray-700">Logo (URL opcional):</label>
                            <input type="text" id="logo" name="logo" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" >
                        </div>
