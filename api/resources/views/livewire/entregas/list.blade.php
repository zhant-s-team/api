        ...
        <div class="p-6 flex space-x-2" wire:key="{{ $entrega->id }}">
            ...
            <div class="flex-1">
                <div class="flex justify-between items-center">
                    <div>
                        <span class="text-gray-800">{{ $entrega->user->name }}</span>
                ...
                @else
                    ...
                    <p class="mt-4 text-lg text-gray-900">Cidade inicial: {{ $entrega->inicio }}</p>
                    <p class="mt-4 text-lg text-gray-900">Cidade destino: {{ $entrega->destino }}</p>
                    <p class="mt-4 text-lg text-gray-900">Porte do veiculo: {{ $entrega->porte_veiculo }}</p>
